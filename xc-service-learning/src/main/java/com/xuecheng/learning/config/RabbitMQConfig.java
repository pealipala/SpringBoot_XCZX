...
public class RabbitMQConfig {
    ...
    //声明队列 添加选课队列
    @Bean(name = XC_LEARNING_ADDCHOOSECOURSE)
     ...
     */
    @Bean
    public Binding binding_finishaddchoose_processtask(@Qualifier(value = XC_LEARNING_FINISHADDCHOOSECOURSE) Queue queue, @Qualifier(value = EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
     ...
     */
    @Bean
    public Binding binding_addchoose_processtask(@Qualifier(value = XC_LEARNING_ADDCHOOSECOURSE) Queue queue, @Qualifier(value = EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
